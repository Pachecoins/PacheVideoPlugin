...
PKG="$TMP_DIR/PacheVideo.pkg"
URL="https://github.com/$REPO/releases/latest/download/PacheVideo-macOS-$ARCH.pkg"
...
echo "PacheVideo quedó instalado. Abrilo desde la carpeta Aplicaciones."
