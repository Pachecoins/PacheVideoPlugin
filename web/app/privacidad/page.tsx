...
export default function PrivacyPage() {
  return <main className="legal-page">
    ...
    <article>
      ...
      <h2>Tus derechos</h2>
      <p>Antes del lanzamiento, configurá el correo de privacidad de PacheVideo para solicitudes de acceso, actualización, rectificación o eliminación de datos. Para Argentina, estos derechos se interpretan junto con la <a href="https://www.argentina.gob.ar/normativa/nacional/ley-25326-64790/texto" target="_blank" rel="noreferrer">Ley 25.326 de Protección de Datos Personales</a>.</p>
      <h2>Cambios</h2>
